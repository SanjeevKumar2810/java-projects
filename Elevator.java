...
public class Elevator
{
	...
	private static final int MIN_FLOOR = 0;
	 ...
	 private static int processingTime = 1000;//ms
	...
	destination) {
	 ...
	 if (currentFloorDestinations[floor])//De-boarding if any people who reached this destination floor
	 System.out.println("UN-BOARDING at Floor : " + floor);
	 if (requestedPathsMap.containsKey(floor)) {//On boarding people and their destination
	...
	requestedPathsMap.isEmpty()) {//STOPPING THE ELEVATOR :checking destinations are reached and request list is empty
